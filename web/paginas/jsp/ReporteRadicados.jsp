        ...
        <script src="../html/scripts/validarFecha.js" type="text/javascript"></script>
          ...
          function buscar(){
              ...
              if(document.form.fechaInR.value.length==10 && document.form.fechaFnR.value.length==10){
                    window.frames[0].location.href="verRadicados.jsp?fi="+document.form.fechaInR.value+"&ff="+document.form.fechaFnR.value;
                          }else{
            alert("Digite fechas");
            }
        }
...
-->
    ...
    <body> 
		...
		<form name="form" id="form" method="post" action="javascript:buscar()" onSubmit="">
		    ...
		    <legend class="style5"  align="center">CONSULTAR&nbsp;RADICADOS</legend>
		  	</div>
