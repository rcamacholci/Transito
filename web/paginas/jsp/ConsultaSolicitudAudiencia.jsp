        ...
        <script src="../html/scripts/validarFecha.js" type="text/javascript"></script>
             ...
             function ConsultarC(){
				if(document.form.comparendo.value.length>0){								
					window.frames[0].location.href = "Detalle_solicitud_Auditoria.jsp?comparendo="+document.form.comparendo.value;
				}else{
...
-->
    ...
    <body> 
		<form name="form" id="form" method="post" action="" onSubmit="return validarCampos()">
						<table>
						<tr><th colspan="5">CONSULTA DE SOLUCITUDES DE AUDIENCIA</th></tr>
							  <tr valign="middle">
								 <th >COMPARENDO</th>
			...
			<iframe src="Detalle_solicitud_Auditoria.jsp?comparendo=0" width="100%" id="respuesta" height="500"  frameborder="0" scrolling="auto"></iframe>
	      </fieldset>
		</form>               
    </body>
</html>
