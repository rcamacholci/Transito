		...
		<script language="javascript" type="text/javascript">
			...
			function buscarPago(){
				if(document.form.pago.value.length!=0){
					window.frames[0].location.href = "verPagosRef.jsp?pago="+document.form.pago.value;
				}else{
...
<%  }
	    ...
	    %>
    <body>
        <form name="form" id="form" method="post" action="verPagosRef.jsp" target="respuesta">
	        <fieldset>
			<table width="100%" border="0" align="center">
			<tr style="border:none;">
				<th colspan="6" align="center" valign="middle"><span class="style7">CONSULTAR PAGOS</span></th>
			</tr>
				<tr align="center">
					<td height="50" colspan="5" align="center" >
						<table border="0" width="100%" id="tabla">
								<tr valign="middle">
								  ...
								  <td width="20%" scope="col" align="right"><input  id="pago" name="pago"  maxlength="15" style="text-align:center;text-transform:uppercase;color:#333333;font:bold; width:125px"  />
							      </td>
