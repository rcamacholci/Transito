...
activarParqueadero(document.getElementById('inmovilizacion').check)
 function CargarPub(){
 //alert("si");
...
// alert("si "+document.form.TP[03].checked);
    if(document.form.TP[03].checked){//  alert("E03");
        document.getElementById('pub').style.display  = "";
        document.getElementById('pub1').style.display = "";
        document.getElementById('pub2').style.display = "";
 ...
 function CargarRe(){
 alert("si "+document.form.C1[01].checked);
    if(document.form.C1[01].checked){
  alert("E03");
        document.getElementById('re1').style.display  = "";
        document.getElementById('reuso').style.display  = "";
        //document.getElementById('pub1').style.display = "";
       // document.getElementById('pub2').style.display = "";
       // document.getElementById('pub3').style.display = "";
       }else{
        ...
        ajax2.onreadystatechange=function() {
                if (ajax2.readyState==4) {
                        ...
                        if(result =='1'){
                            ...
                            //alert(document.form.nombresp.value)
                            //document.form.documentop.value=Doc;
                            //alert(document.form.documentop.value)
                            //document.form.documentop.disabled = true;
                            //alert("DISISABLE")
                            //document.form.tipoDocumentop.value=Td;
                            //alert(document.form.tipoDocumentop.value)
                           ...
                           document.getElementById("tipoDocumentop").value = Td
                           document.getElementById("documentop").disabled=true
                           document.getElementById("tipoDocumentop").disabled=true
...
function buscarGrua(input){
    var placa = input.value
    if(placa.length>0){
        var ajax = new nuevoAjax()
        ajax.open("POST", "getGrua.jsp",true)
        ajax.onreadystatechange=function() {
            if (ajax.readyState==4) {
                ...
                if(result=='si'){
                    ...
                    document.form.Gplaca.value = nombre;
                }else{
                    document.form.Gplaca.value='';
                    adicionarGrua(placa);
                }
            }
        }
...
function adicionarGrua(placa){
    ...
    url = "AdicionarGrua.jsp?Numero="+placa;
                              ...
                              <td>
                                    ...
                                    <table border="0" align="center" width="550px" cellpadding="1" cellspacing="2" style="border:none">
                                        <tr>
                                            ...
                                            <td class="input"><input name="comparendo" autocomplete="off"  type="text" class="text" onBlur="existeComparendo(this)"/></td>
                                            <td>&nbsp;</td>
...
<button name="bfecha" type="button" id="bfecha" class="bdate" ><img src="../html/images/calendario.png" width="19" height="18"/></button>
                                        ...
                                        <tr>
                                            ...
                                            <td class="input"><input name="placa" id="placa" type="text" onKeyPress="javascript: return BloquearComa(event)" maxlength="6"  class="text" onBlur="buscarPlaca(this)"/>                                            </td>
                                            <td>&nbsp;</td>
                                            <td class="label">Licencia Transito</td>
                                            <td class="input"><input name="licenciaTransito" id="licenciaTransito" type="text"  class="text" onKeyPress="return soloNumeros(event)" onClick="buscarPropietario()" onBlur="CargarPub()"/></td>
                                        </tr>
                                        <tr>
...
<tr id="pub3">
 ...
 <tr id="alm1">
  ...
  <td colspan="2">&nbsp;<label id="reuso" name="reuso"> <span class="text">Se Reuso</span></label></td>
  </tr>								<!--/////////////////////////////////-->
 <tr id="alm2">
    <td colspan="2" class="label">&nbsp;Prueba de alcolemia</td>
    <td  class="check">&nbsp;<input type="radio" id="C1" name="C1" value="si" checked="checked"/></td>
    <td  class="check">&nbsp;<input type="radio" id="C1" name="C1" value="no" onClick=""/></td>
    <td colspan="1">&nbsp;<span class="text">Si</span><input type="radio" id="re1" name="re1" value="si" checked="checked" onclick="CargarRe()"/>&nbsp;&nbsp;
                    <span class="text">No</span><input type="radio" id="re1" name="re1" value="no" checked="checked"/></td>
		<td colspan="1"></td>
    </tr>
...
<!----------------------------------------------------->
<tr>
                               <td align="center" colspan="5"><div class="text">Datos&nbsp;Del&nbsp;Testigo</div></td>
                                                    </tr><tr>
                                            <td class="label">Tipo Documento </td>
                                            <td class="input"><select name="tipoDocumentop" id="tipoDocumentop" class="select" onChange="consultaPersonaP(this.id, 'documentop', 'nombresp')">
                            <%
                            lista_id1 = modelo.listadoParametros(5);
                            itrtor1 = lista_id1.iterator();
                            while (itrtor1.hasNext()) {
                                parametro = (Parametro) itrtor1.next();%>
                                                    <option value="<%=parametro.getCodigo() + ""%>"><%=parametro.getNombre()%></option>
                                                    <%  }%>
                                                ...
                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%" align="center" class="check"> Inmovilizacion
                                                            <input name="inmovilizacion" type="checkbox" id="inmovilizacion" value="1" onClick="activarParqueadero(this)" checked />                                                        </td>
...
<tr>
                                            ...
                                            <td class="input"><input name="Npatio" id="Npatio" type="text" onKeyPress="javascript: return BloquearComa(event)" maxlength="6"  class="text" />                                            </td>
                                            <td>&nbsp;</td>
                                            <td class="label" colspan="1">Direccion<span class="input">
                                            </span></td>
                                            <td class="input"><input name="Dpatio" id="Dpatio" type="text"  class="text" disabled/></td>
                                      </tr>
                                        <tr>
                                            <td class="label">Grua No</td>
                                            <td class="input"><input type="text" id="GruaN" name="GruaN"  onKeyPress="return soloNumeros(event)" onBlur="buscarGrua(this)" class="text" ></td>
                                            <td>&nbsp;</td>
                                            <td class="label">Placa Grua</td>
                                            <td class="input"><input type="text" id="Gplaca" name="Gplaca" disabled></td>
                                        </tr>
<tr>
                                            <td class="label">Consecutivo No</td>
                                            <td class="input"><input name="Ncop" id="Ncop" type="text" onKeyPress="javascript: return BloquearComa(event)" maxlength="6"  class="text" />                                            </td>
                                            <td>&nbsp;</td>
