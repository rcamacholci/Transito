		...
		<script language="javascript" type="text/javascript">
			...
			function buscarNumero(){
                            if(document.form.numero.value.length>0){
                                    window.frames[0].location.href = "verTituloValor.jsp?num=1&numero="+document.form.numero.value;
                            }else{
                        ...
                        function buscarPlaca(){
                            if(document.form.placa.value.length>0){
                                    window.frames[0].location.href = "verTituloValor.jsp?num=2&numero="+document.form.placa.value;
                            }else{
                                    alert("Digite el numero del titulo Valor");
                            }
			}
				...
				if(document.form.fechaI.value.length==10){
					...
					window.frames[0].location.href = "verTituloValor.jsp?num=3&fechaI="+document.form.fechaI.value+"&fechaF="+document.form.fechaF.value;
                                    }else{
                         ...
                         function paso(){
                            if(document.form.fechaI.value.length>0){
                                if(document.form.fechaF.value.length>0){
                                    document.form.action='consultarTituloValor.jsp'
			...
			function verReporte(){
				...
				var dir = "/recaudoycartera/ReporteTitulosValor.jasper";
                                var nombre = "titulosValor";
...
-->
    ...
    <%
	 if(request.getParameter("fechaI")!=null&&request.getParameter("fechaF")!=null&&!request.getParameter("fechaI").isEmpty()&&!request.getParameter("fechaF").isEmpty()){
        ...
        session.setAttribute("titulosValor", parameters);
%>
        <script language="javascript" type="text/javascript">
               verReporte();
        </script>
...
<%  }
	    ...
	    %>
    <body> 
		<form name="form" id="form" method="post" action="verTitulos.jsp" >
	        <fieldset>
			<table width="100%" border="0" align="center">
			<tr style="border:none; background:url(../html/images/inicio_3.png)">
				<td colspan="6" align="center" valign="middle"><span class="style7">CONSULTAR TITULO VALOR</span></td>
			</tr>
				<tr>
				...
				<td width="19%" scope="col" colspan="2"><input id="consultar"  name="consultar2" type="button" value="Consultar" style="color:#333333" onClick="buscarPlaca()"/></td>
						...
						<table border="0" width="100%" id="tabla1" style="" >
								<tr valign="middle">
								   <td width="40%" height="26" align="right"><label style="color:#333333"><span class="style5">NUMERO</span></label>
								  </td>
								  <td width="20%" scope="col" align="right"><input  id="numero" name="numero" style="text-align:center;color:#333333;font:bold; width:125px" maxlength="6" />
							      </td>
								  
								  <td width="21%" scope="col"></td>
				<td width="19%" scope="col" colspan="2"><input id="consultar"  name="consultar2" type="button" value="Consultar" style="color:#333333" onClick="buscarNumero()"/></td>
