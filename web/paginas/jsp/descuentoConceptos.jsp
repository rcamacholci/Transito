...
<table width="953" border="1">
  <tr>
    ...
    <div id="lateral">
        <iframe src="verTramiteDescuentos.jsp" id="verTramiteDescuentos" name="verTramiteDescuentos" marginwidth="0" height="500" width="100%" marginheight="0" align="top" scrolling="auto" style="border:none"></iframe>
    </div>

    <div id="div-border"></div>
    <div id="principal">
    <iframe src="" id="verTablaDescuento" name="verTablaDescuento" marginwidth="0" height="300" width="100%" marginheight="0" align="top" scrolling="auto" style="border:none"></iframe>
