...
if(session.getAttribute("usuario")!=null){
    ...
    if(model!=null){
        ...
        java.sql.Date fechaM = new java.sql.Date(new java.text.SimpleDateFormat("dd/MM/yyyy").parse(request.getParameter("fecha")).getTime());
        String pagom = request.getParameter("referencia");
        if(!request.getParameter("liqrunt").equals("1")){
                if(request.getParameter("pago").equals("9")){
       ...
       <table width="100%" border="0" id="tabla_general" name="tabla_general" style="display:block">
          ...
          if(!tikec.equals("")){
            %>
                    ...
                    <tr>
                                             <!--<td colspan="4" align="center" style="font-size:24px"><input type="button" value="Imprimir Codigo"  onclick="Codigo(1)" /></td>-->
                            ...
                            try{
                                ...
                                if(paso&&liqtransito){
                                    if(Integer.parseInt(request.getParameter("pago"))!=7){
                                        ...
                                        tiquete.setEstado(4);
                                        if(tiquete.getTipo_pago() != 9){
                                            tiquete.setFecha(actual);
                                        }else{
                                            tiquete.setFecha(fechaM);
                                        }
                                        ...
                                        if (tiquete.getTipo_pago()!= 1 && tiquete.getTipo_pago()!= 9) {
                                                        ...
                                                        if(liquidacion.getFk_concepto()>=32&&liquidacion.getFk_concepto()<=35){
                                                            ...
                                                            if(vigenciaInicial!=0){
                                                                ...
                                                                switch((int)liquidacion.getFk_concepto()){
                                                                    case 32:tipoFk = 3;break;
                                                                    case 33:tipoFk = 4;break;
                                                                    case 34:tipoFk = 1;break;
                                                                    case 35:tipoFk = 2;break;
                                                                }
                                ...
                                for (int i = 0 ; i< listaLiquidacion.size(); i++) {
                                    ...
                                    if (liquidacion.getTipo() == 1) {
                                        ...
                                        if (sumatoria >= liquidacion.getTotal()) {
                                            ...
                                            sumatoria = sumatoria - liquidacion.getTotal();
                                           int sw =0;
                                            if(cartera.getTipo()==1||cartera.getTipo()==3||cartera.getTipo()==5||tiquete.getTipo_pago()==2 || tiquete.getTipo_pago()==9){
