...
<html>
    ...
    <body>
        <form name="forma"  onSubmit="return validarDocumento(this)"  method="post" action="FormularioPersonaJuridica.jsp">
            <table width="49%" border="0" align="center">
                <tr style="border:none; background:url(../../html/images/inicio_3.png)">
                    <td colspan="11" align="center"><span class="style2 style14 style3 Estilo6">REGISTRAR DATOS DE PERSONA JURIDICA</span></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       if (parametro.getCodigo() == 2) {%>
                                    ...
                                    <td width="23%">
                                        <input name="documento" id="documento" type="text" style="color:#333333; width:100px; text-align:center" value=""/>
                                    </td>
