...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form name="form" id="form" method="post" action="procesarSancionComparendo.jsp" onsubmit="return validForm();">
            <div align="center">
                <table width="75%">
                    <tr>
                        <td colspan="5">&nbsp;</td>
                        ...
                        <td><div align="center">
                                <table width="100%" class="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td><div align="left"><input required="true" type="text" name="fechaResolucion" id="fechaResolucion" class="date"  style="background-image:url(../../html/images/mascara.png); background-position:center; background-repeat:no-repeat; text-align:center" onKeyUp="mascara(this,'/',true)" maxlength="10" />
                                                <span class="input">
                                    ...
                                    <tr>
                                        ...
                                        <td width="85%"><div align="left">
                                                ...
                                                <input type="text" name="valor" value="<%=valorI.getValor()%>" id="valor" onkeypress="return validNumber(event);"  />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr> 
