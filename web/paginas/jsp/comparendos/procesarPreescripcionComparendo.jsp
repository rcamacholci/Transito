        ...
        try {
            ...
            if (request.getParameter("idComparendo") != null) {
                ...
                if (comparendo != null) {
                    ...
                    boolean preescripcionAplicada = procesoC.adicionarSimitResolucionXPrescripcion(
                            model,
                            usuario,
                            comparendo,
                            resolucion,
                    ...
                    if (preescripcionAplicada) {%>
                        <jsp:forward page="procesoContravencional.jsp">
                            <jsp:param name="msg" value="La preescripcion ha sido realizada con exito"/>
                            <jsp:param name="idC" value="<%= comparendo.getId_comparendo() %>"/>
                        </jsp:forward> 
                    <%  
                    } else { %>
                        <jsp:forward page="procesoContravencional.jsp">
                            <jsp:param name="msg" value="No ha sido posible realizar el proceso de preescripcion"/>
                            <jsp:param name="idC" value="<%= comparendo.getId_comparendo() %>"/>
                        </jsp:forward> 
                    <%  
                    }
