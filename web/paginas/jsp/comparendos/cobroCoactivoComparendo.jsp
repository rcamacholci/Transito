...
<%
    ...
    System.out.println("ENTRO A SANCIONAR");
    if (model != null) {
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form name="form" id="form" method="post" action="procesarCobroCoactivoComparendo.jsp" onsubmit="return validForm();">
            <div align="center">
                <table width="75%">
                    <tr>
                        <td colspan="5">&nbsp;</td>
                    ...
                    <tr>
                        <td><div align="center">
                                <table width="100%" class="dataTable">
                                    <tr>
                                        <td colspan="2"><div align="center" class="title_">Sanción</div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><div align="left"><input type="text" name="fechaResolucion" id="fechaResolucion" class="date"  style="background-image:url(../../html/images/mascara.png); background-position:center; background-repeat:no-repeat; text-align:center" onKeyUp="mascara(this,'/',true)" maxlength="10" />
                                                <span class="input">
                                    ...
                                    <tr>
                                        ...
                                        <td width="85%"><div align="left">
                                                ...
                                                <input type="text" name="valor" value="<%= cartera.getSaldo() %>" id="valor" onkeypress="return validNumber(event);" readonly />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr> 
