        ...
        try {
            ...
            if (request.getParameter("idComparendo") != null) {
                ...
                if (comparendo != null) {
                    ...
                    boolean preescripcionAplicada = procesoC.adicionarSimitResolucionXAnulacion(
                            model,
                            usuario,
                            comparendo,
                            resolucion,
                    ...
                    if (preescripcionAplicada) {%>
                        <jsp:forward page="procesoContravencional.jsp">
                            <jsp:param name="msg" value="La anulacion ha sido realizada con exito"/>
                            <jsp:param name="idC" value="<%= comparendo.getId_comparendo() %>"/>
                        </jsp:forward> 
                    <%  
                    } else { %>
                        <jsp:forward page="procesoContravencional.jsp">
                            <jsp:param name="msg" value="No ha sido posible realizar el proceso de anulacion"/>
                            <jsp:param name="idC" value="<%= comparendo.getId_comparendo() %>"/>
                        </jsp:forward> 
                    <%  
                    }
