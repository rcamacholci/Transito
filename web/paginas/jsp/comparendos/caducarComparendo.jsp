...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form name="form" id="form" method="post" action="procesarCaducidadComparendo.jsp" onsubmit="return validForm();">
            <div align="center">
                <table width="75%">
                    <tr>
                        <td colspan="5">&nbsp;</td>
                    ...
                    <tr>
                        <td><div align="center">
                                <table width="100%" class="dataTable">
                                    <tr>
                                        <td colspan="2"><div align="center" class="title_">Caducar</div></td>
                                    </tr>
                                    <tr>
