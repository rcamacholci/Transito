...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form name="form" id="form" method="post" enctype="multipart/form-data" action="procesarSolicitudAudiencia.jsp" onsubmit="return validForm();">
            <div align="center">
                <table width="86%">
                    <tr>
                        <td colspan="5">&nbsp;</td>
                    ...
                    <tr>
                        <td><div align="center">
                                <table width="100%" class="dataTable">
                                    ...
                                    <tr>
                                        <td><div align="left" style="font-weight: bold">Numero&nbsp;Radicaci&oacute;n</div></td>
                                        <td><div align="left">
                                                <input type="text" name="numero_radicacion" id="numero_radicacion" style="width:50%" />
                                            </div></td>
                                        <td><div align="left" style="font-weight: bold">Fecha&nbsp;Radicacion</div></td>
                                        <td><div align="left">
                                    ...
                                    <tr>
                                      <td><div align="left" style="font-weight: bold">Adjuntar Archivo</div></td>
                                      <td colspan="3"><div align="left">
                                        <input type="file" name="attach" id="attach" style="width:80%" />
                                      </div></td>
                                    </tr>
                                    <tr>
