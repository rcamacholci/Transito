...
<%
    ...
    if (model != null) {
        ...
        if (request.getParameter("idp") != null && request.getParameter("ns") != null) {
            if (request.getParameter("cfg") != null) {
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form name="form" id="form" method="post" action="procesarExoneracionComparendo.jsp" onsubmit="return validForm();">
            <div align="center">
                <table width="75%">
                    <tr>
                        <td colspan="5">&nbsp;</td>
                    ...
                    <tr>
                        <td><div align="center">
                                <table width="100%" class="dataTable">
                                    <tr>
                                        <td colspan="2"><div align="center" class="title_">Exoneraci&oacute;n</div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr> 
                                        ...
                                        <td><div align="left">
                                                <TagForm:Select
                                                    ...
                                                    filter="fk_grupo=359 order by 2"
                                                    valueField="codigo"
                                                    dataField="nombre"
                                                    value='<%= "" %>'
                                                    estado='<%= ""  %>'
