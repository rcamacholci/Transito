	...
	function evaluarCampos(){
	   ...
	   if(document.form.nombre.value.length==0){
        ...
        function verificarDatos(){
            var pla = document.form.placaRNRYS.value;
            var ser = document.form.serie.value;
            var vin = document.form.vin.value;
                if(pla!=null||ser!=null||vin!=null){
                    document.form.action = "verificarDatosRNRYS.jsp";
                   // document.form.action = "seleccionTramites.jsp?rn=5&placaRN=RNRYS12";
        ...
        function verificarDatos3(){
               ...
               var ajax = new nuevoAjax();
                ajax.open("POST", "verificarDatosRNRYS.jsp",true);
                ajax.onreadystatechange=function() {
                    if (ajax.readyState==4) {
                        alert("Entro");
            ...
            function verificarDatos2() {
                ...
                document.form.solicitar.disabled = true;
                var ajax = new nuevoAjax();
                ajax.open("POST", "GetPreasignacionRunt.jsp", true);
                ajax.onreadystatechange = function(){
                    ...
                    if (ajax.readyState == 4) {
                        ...
                        if (result == '1') {
                            ...
                            var msg = docxml.getElementsByTagName("msg")[0].childNodes[0].nodeValue;
                             alert("Adventiencia \n " + msg);
                            document.form.solicitar.value = "Validar Datos";
                            document.form.solicitar.disabled = false;
               ...
               var ajax = new nuevoAjax();
                ...
                ajax.onreadystatechange=function() {
                    if (ajax.readyState==4) {
                        ...
                        var result = docxml.getElementsByTagName('result')[0].childNodes[0].nodeValue;
                            if(result=='1'){
                              	window.location.href = "seleccionTramites.jsp?placaRNRYS=1";
                            }else{
                                alert(" No se encontro registro ");
                                document.form.motor.readOnly = false;
                                document.form.chasis.readOnly = false;
...
<form name="form" method="post" action="seleccionTramites.jsp">
    <input type="hidden" name="rnrys" value="1" id="rnrys" />
  ...
  <tr>
    <td width="80%" align="center">
		...
		<table width="80%" border="0" cellspacing="2" cellpadding="2" align="center">
			  <tr>
			  	<td colspan="5" background="../html/images/inicio_3.png"><div align="center" class="Estilo4 Estilo5">CONSULTA POR GUARISMO DE RNRYS</div></td>
			  </tr>
			  ...
			  <tr>
			   ...
			   <tr>
                               <td align="left"><span class="Estilo3">PLACA</span></td>
                               <td align="center"><input type="text" name="placaRNRYS" id="placaRNRYS" value="" style="text-align:center; font-size:12px; color:#000033; font-weight:bold; width:170px"/></td>
                <td>&nbsp;</td>
	 ...
	 <td>&nbsp;</td>
                                  ...
                                  <input type="button" name="solicitar" value="Verificar Datos" style="width:200px" onclick="verificarDatos2()" />
                              </td>
			  </tr>
