...
<script language="javascript" type="text/javascript">
    ...
    function CancelarPrestamo(){
        var id = document.form.idPrestamo.value;
        //alert("value : "+document.form.idPrestamo.value);
        window.location.href = "procesar_prestamo_carpeta.jsp?num=3&idPrestamo="+id;
    }
...
<table width="90%" align="center" border="0">
  ...
  <tr style="border:none; background:url(../html/images/inicio_3.png)">
  	<td colspan="4" align="center"><span class="style7">EDITAR PRESTAMO</span></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td><span class="style8">FOLIOS</span></td>
    <td><input type="text" name="folios" id="folios" style="width:110px; text-align:center; font:bold" value="<%=carpeta.getFolios()%>"/></td>
     </tr>
	    <td><span class="style8">SOLICITANTE </span></td>
          <td colspan="1"><input type="text" name="usuario" id="usuario" style="width:110px; font:bold; text-align:center" value="<%= usuario.getNombre()%>"   disabled="disabled"/></td>
		  <td><input type="text" name="idPrestamo" id="idPrestamo" style="width:110px; display:none" value="<%=request.getParameter("idpc")%>"    disabled="disabled"/></td>
     </tr>
  ...
  <tr>
    <td colspan="5" align="center">
		<table width="90%" border="0" align="center">
          <tr>
              <th width="33%" scope="col"><input name="adicionar"  type="submit" id="adicionar" value="Prestar Carpeta" style="width:130px; text-align:center" /></th>
              <th width="33%" scope="col"><input name="adicionar"   type="button"id="adicionar"  onclick="CancelarPrestamo()" value="Anular Prestamo" style="width:130px; text-align:center" /></th>
            <th width="33%" scope="col"><input name="cancelar" onclick="salir()" type="button" id="cancelar" value="Volver" style="width:130px; text-align:center" /></th>
