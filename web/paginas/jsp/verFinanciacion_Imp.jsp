...
<%
    try {
         Financiacion_Imp financiacion_Imp = null;
            ...
            if (((java.util.LinkedList) session.getAttribute("permisosU")).contains(request.getServletPath().substring(request.getServletPath().lastIndexOf("/") + 1, request.getServletPath().length()))) {
                Model model = (Model) session.getAttribute("model");
                    if(request.getParameter("idFinanciacion")!=null||request.getParameter("numeroF")!=null){
                        if(request.getParameter("idFinanciacion")!=null){
                            ...
                            financiacion_Imp = model.consultarFinanciacion_Imp(idFinanciacion);
                        }else{
                            if(request.getParameter("numeroF")!=null){
                                financiacion_Imp = model.consultarFinanciacion_Imp(request.getParameter("numeroF").trim().toUpperCase());
                            }
                        }
                    }
                /*if(request.getParameter("opcion").equals("2")){
                    if(request.getParameter("tipo")!=null&&request.getParameter("documento")!=null){
                        ...
                        if(persona!=null){
                          financiacion = model.consultarFinanciacionByPersona(persona.getId_persona());
                        }
                    }
                }*/

                    if(financiacion_Imp!=null){
                      idFinanciacion = financiacion_Imp.getId_financiacion_Imp();
                      String estado = model.consultarParametroName(59, financiacion_Imp.getEstado());
                      String placa = "";
                      Vehiculo vehiculo = model.consultarVehiculoById(financiacion_Imp.getFk_vehiculo());
                      if(vehiculo!=null)
                          placa = vehiculo.getPlaca();
                      Persona p = model.consultarPersona(financiacion_Imp.getFk_persona());
                      String persona = "";
                      if(p!=null){
                      ...
                      Tipo_Financiacion tipo = model.consultarTipoDeFinanciacion(financiacion_Imp.getFk_tipo_financiacion());
                      String tipoF = "";
                      if(tipo!=null)
                          ...
                          String direccionN = "financiaciones_imp/AcuerdoPago_vehiculo.jasper";
                                ...
                                <form action="javascript:consultarDatosFinanciacion()">
                                    <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                        <tr>
                                            ...
                                            <td scope="col"><input name="text" type="text" class="text" value="<%=financiacion_Imp.getNumero()%>" readonly/></td>
                                            <td scope="col" class="label">Fecha</td>
                                            <td scope="col"><input name="fecha" type="text" class="text" value="<%=new java.text.SimpleDateFormat("dd/MM/yyyy").format(financiacion_Imp.getFecha())%>" readonly/></td>
                                            <td scope="col" class="label">Valor</td>
                                            <td scope="col"><input name="valor" type="text" class="text" value="<%=new java.text.DecimalFormat("#,##0").format(financiacion_Imp.getValor())%>" readonly/></td>
                                        </tr>
                                        <tr>
                                            <td scope="col" class="label">Cuota Inicial</td>
                                            <td scope="col"><input name="text" type="text" class="text" value="<%=financiacion_Imp.getCuota_inicial()%>" readonly/></td>
                                            <td scope="col" class="label">Numero Cuotas</td>
                                            <td scope="col"><input name="fecha" type="text" class="text" value="<%=financiacion_Imp.getCuotas()%>" readonly/></td>
                                    ...
                                    <td valign="top" width="420px">
                                        <fieldset>
                                            ...
                                            <table border="1" align="center" cellpadding="1" cellspacing="0" width="370px">
                                                ...
                                                <tbody>
                                                    <%
                                                    java.util.List<Detalle_Financiacion_Imp> listaF = model.consultarDetalleFinanciacion_Imp(financiacion_Imp.getId_financiacion_Imp());
                                                    java.util.HashMap estadoDF = model.crearHashParametros(353);
                                                    for(Detalle_Financiacion_Imp df:listaF){ %>
                                                        <tr>
                                    ...
                                    <td valign="top" width="420px">
                                        <fieldset>
                                            ...
                                            <table border="1" align="center" cellpadding="1" cellspacing="0" width="370px">
                                                ...
                                                <tbody>
                                                    <%
                                                    java.util.List<Financiacion_Cartera_Imp> listaC = model.consultarCarterasFinanciadas_Imp(financiacion_Imp.getId_financiacion_Imp());
                                                    java.util.HashMap estadoC = model.crearHashParametros(21);
                                                    for(Financiacion_Cartera_Imp dc:listaC){
