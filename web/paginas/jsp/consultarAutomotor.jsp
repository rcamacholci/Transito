...
<%@page import="java.util.*"%>
    <body>
        ...
        <form id="form" name="form" method="post" target="acta" action="consultarAutomotor2.jsp">
      <fieldset>
		  ...
		  <tr>
		   ...
		   for (int i = 0; i < tipoDocumentos.size(); i++) {
			...
			<td width="14%"><span class="Estilo6">NUMERO NIT</span></td>
                        <td width="18%"><input name="numeroImportador" type="text" id="numeroImportador" value="900153453"  style="width:150px; font-size:10px; color:#333333; text-align:center" onblur="consultaPersona()"/></td>
