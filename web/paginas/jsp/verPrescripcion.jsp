    ...
    <body>
        <%
            ...
            if (request.getParameter("excel") != null) {
                ...
                response.setHeader("Content-Disposition", "attachment;filename=\"ReportePrescripciones.xls\"");
                Date date = new Date();
        ...
        <table width="100%" border="1" cellpadding="1" cellspacing="0">
            <tr style="border:none; background:url(../html/images/inicio_3.png)">
                <td width="12%"  style="border:none"><div align="center" class="<%=request.getParameter("excel") != null?"":"style9"%>">NUMERO</div></td>
                <td width="12%"  style="border:none"><div align="center" class="<%=request.getParameter("excel") != null?"":"style9"%>">FECHA</div></td>
                <td width="12%"  style="border:none"><div align="center" class="<%=request.getParameter("excel") != null?"":"style9"%>">PLACA</div></td>
                <td width="12%"  style="border:none"><div align="center" class="<%=request.getParameter("excel") != null?"":"style9"%>">VIGENCIA INICIAL</div></td>
                <td width="12%"  style="border:none"><div align="center" class="<%=request.getParameter("excel") != null?"":"style9"%>">VIGENCIA FINAL</div></td>
                <td width="12%"  style="border:none"><div align="center" class="<%=request.getParameter("excel") != null?"":"style9"%>">ESTADO</div></td>
                <td width="12%"  style="border:none"><div align="center" class="<%=request.getParameter("excel") != null?"":"style9"%>">USUARIO</div></td>
            </tr>
