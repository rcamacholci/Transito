...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="form1" action="LiberarPlaca.jsp" method="post">
            <table width="100%" border="1" cellpadding="1" cellspacing="0">
                ...
                <%
                    ...
                    if (request.getParameter("num").equals("3")) {
                        ...
                        java.util.List lista = modelo.listarPreasignacionesVencidas();
                        for (int i = 0; i < lista.size(); i++) {
                            Preasignacion preasignacion = (Preasignacion) lista.get(i);
                ...
                <%
                    ...
                    if (!lista.isEmpty() && !response.getContentType().equals("application/vnd.ms-excel;charset=iso-8859-1")) {
                                %>
                                <tr style="background:url(../html/images/inicio_3.png)">
                                    <td colspan="6" align="center" style=" border-color:#CCCCCC">&nbsp;</td>
                                    <td colspan="1" align="center" style=" border-color:#CCCCCC" >
                                        <input id="Liberar"  name="Liberar" type="submit" value="Liberar Placas" style="color:#333333"/>
                                    </td>
                                </tr>
                                <%
                                        }
