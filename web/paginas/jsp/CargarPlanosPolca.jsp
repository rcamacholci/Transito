...
-->
    ...
    <body>
        <form name="form" action="procesarPlanosPolca.jsp" method="POST" enctype="multipart/form-data" target="respuesta">
			<table align="center" border="0" width="100%">
				<tr>
					<td  height="40px" align="center">
			            <h1 class="style1">Cargar Planos Polca </h1>					</td>
				</tr>
				<tr>
					<td height="40px" align="center">
			           <input type="hidden" name="filename" value="comparendos.txt" />
