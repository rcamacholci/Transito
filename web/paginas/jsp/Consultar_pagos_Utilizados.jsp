		...
		<script language="javascript" type="text/javascript">
			...
			function buscarPago(){
				if(document.form.pago.value.length!=0){
					window.frames[0].location.href = "verPagosConsulta.jsp?pago="+document.form.pago.value;
				}else{
...
<%  }
	    ...
	    %>
    <body> 
        <form name="form" id="form" method="post" action="verPagosConsulta.jsp" target="respuesta">
	        <fieldset>
