...
<script language="javascript" type="text/javascript">
	function newP(){
		window.frames[0].location.href = "adicionarPropietario.jsp?id=1";
	}
</script>
</head>
<%@ page import="modelo.*"%>
...
<table width="100%" border="0">
  <tr>
  	<td width="95%"><div align="center"><span class="style2">PROPIETARIOS</span></div></td>
  ...
  <tr>
	...
	<iframe src="verPropietarios.jsp?id=1" id="propietarios" name="propietarios" marginwidth="0" height="500" width="100%" marginheight="0" align="top" scrolling="auto" style="border:none"></iframe></td>
  </tr>
</table>
<% }
}else{ %>
