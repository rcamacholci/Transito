    ...
    <!-- filter: alpha(opacity=85);-moz-opacity:0.85; -->
		...
		<script language="javascript" type="text/javascript">
            ...
            function paso(){
                                if(document.form.numOficio.value.length>0){
                                      if(document.form.fechaO.value.length>0){
                                            document.form.action='LevantarOficioEmbargo.jsp'
           ...
           function verReporte(){
            ...
            var dir = "/recaudoycartera/embargos/levantamientoEmbargo.jasper";
            var nombre = "Oficios";
                                ...
                                if(prop!=null){
                                    Persona propietario = modelo.consultarPersona(prop.getFk_persona());
                                        if(propietario!=null){
                                            ...
                                            parameters.put("IDEMBARGO",embargo.getId_embargo());
                                            parameters.put("PLACA",vehiculo.getPlaca());
                                            parameters.put("OFICIO",oficioE.getNum_oficio());
		...
		<form name="form" id="form" method="post" action="">
			...
			<table width="100%" border="0" align="center">
				<tr style="border:none; background:url(../html/images/inicio_3.png)">
					<th colspan="5" align="center"><span class="style2 style14">IMPRIMIR OFICIO DE EMBARGOS </span></th>
		      	<tr>
					<tr valign="middle">
					<td width="20%"  align="center" scope="col" ><span class="style7" style="font-size: 11px">
                      <label ><span class="style7" style="font-size: 11px"><span class="style7" style="font-size: 12px">N&deg; OFICIO </span></span></label>
					</span></td>
					...
					<td width="20%"  align="center" scope="col" ><span class="style7" style="font-size: 11px">
                      <label ><span class="style7" style="font-size: 11px"><span class="style7" style="font-size: 12px">FECHA OFICIO </span></span></label>
					</span></td>
					<td width="20%">
						  <span class="Estilo8">
