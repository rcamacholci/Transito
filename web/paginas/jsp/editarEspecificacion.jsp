...
if (vehiculo!=null){
  ...
  if(request.getParameter("idv")!=null){
	...
	HashMap datos = modelo.listarEspecificacionesVehiculo(vehiculo.getPlaca());
  

%>
<body>
<form name="form" method="post" action="procesar_especificacion.jsp?id=2">
...
<fieldset>
 <div align="center">
  <legend class="style7 style6 style5 style2"><strong>EDITAR</strong></legend>
 </div>
...
<table width="90%" align="center" border="0">
  ...
  <tr>
		...
		<select name="especificacion" id="especificacion" style="width:120px">
		 <% 
			...
			while (it.hasNext()) {
                 ...
                 if(parametro.getCodigo()==(dv.getParam_codigo())){%>
    ...
    <td width="33%"><input name="parametro" id="parametro" style="width:120px; text-align:center" value="<%=dv.getValor()!=null?dv.getValor():"" %>"/></td>
  </tr>
  <tr>
    <td><span class="Estilo1 style1">FECHA.&nbsp;INICIAL </span></td>
    <td><input type="text" name="fecha_inicial" id="fecha_inicial" value="<%=new java.text.SimpleDateFormat("dd/MM/yyyy").format(dv.getFecha_ini())%>" style="width:97px; text-align:center" onkeyup="mascara(this,'/',true)" maxlength="10"/>
    ...
    <td><input type="text" name="fecha_final" id="fecha_final" value="<%=dv.getFecha_fin()!=null?new java.text.SimpleDateFormat("dd/MM/yyyy").format(dv.getFecha_fin()):""%>" style="width:97px; background-image:url(../html/images/mascara.png); background-position:center; background-repeat:no-repeat; text-align:center" onkeyup="mascara(this,'/',true)" maxlength="10"/>
  ...
  <tr>
    <td colspan="5" align="center">
		<table width="100%" border="0">
          <tr>
            <th width="50%" scope="col"><input name="adicionar" type="button" id="adicionar" value="Editar" style="width:80px; text-align:center" onclick="revisar()"/></th>
            <th width="50%" scope="col"><input name="cancelar" type="button" id="cancelar" value="Cancelar" style="width:80px; text-align:center" onclick="salir()"/></th>
          </tr>
        </table>	  </td>
    </tr>
</table>
