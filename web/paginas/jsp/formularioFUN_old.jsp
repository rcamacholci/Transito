                 ...
                 if (lsec.contains("panelPropietarios")) { %>
                   ...
                   state = enable ? "" : "disabled";%>
                           ...
                           Persona persona = model.consultarPersona(aseguradora.getFk_persona());%>
                                        ...
                                        <table width="100%" border="0" id="panelEspecificaciones" style="display:none" align="center">
                                            ...
                                            <tr>
                                                <td width="100%" align="center"><iframe src = "radicarEspecificaciones.jsp" id="espc" name="espc" marginwidth="0" height="150" width="800" marginheight="0" scrolling="auto" style="border:none"></iframe></td>
                                            </tr>
                                            <% } %>
                                        </table>
                   ...
                   state = enable ? "" : "disabled";%>
                    ...
                    if (tipot.getClase_tramite() == 1) {%>
                     ...
                     state = enable ? "" : "disabled";%>
                                                <td><span class="Estilo2"> <span class="Estilo6">
                                                            <label><font face="Arial, Helvetica, sans-serif"><b>Modalidad</b></font></label>
                                                        </span> </span></td>
...
<tr>
                                                <td>
                                                    <span class="Estilo2">
                                                        <span class="Estilo6"><label><font face="Arial, Helvetica, sans-serif"><b>Modalidad Servisio</b></font></label>
                                                        </span> 
                                                    </span> 
                                                </td>
                                                <td>
                                                    <select name="cmbModServicio" id="cmbModServicio" style="width:200px;color:#333333" >
                                                        ...
                                                        <%
                                                            ...
                                                            for(int i = 0;i<modServicio.size();i++){
                                                                Parametro mods = (Parametro)modServicio.get(i);
                                                        %>
                                                            <option value="<%=mods.getCodigo()%>" selected><%=mods.getNombre()%> </option>
                                                        <%
                                                            }
                                                        %>                                                        
                                                    </select>                                                                    
 ...
 <%
                                                            ...
                                                            for(int i = 0;i<aream.size();i++){
                                                                Parametro mods = (Parametro)modServicio.get(i);
                                                        %>
                                                            <option value="<%=mods.getNombre()%>" selected><%=mods.getNombre()%> </option>
                                                        <%
                                                            }
                                                        %>
                                                    </select> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="cmbDepartamento" id="cmbDepartamento" style="width:200px;color:#333333" >
                                                ...
                                                <td>
                                                    <select name="cmbMunicipio" id="cmbMunicipio" style="width:200px;color:#333333" >
                                  ...
                                  if (dupla[0] == 2) {
                                      if (dupla[1] != 48) {%>
                                        ...
                                        <table width="100%" border="0" id="panelImportacionRNMA" style="display:none">
                                            ...
                                            <tr style="background:url(../html/images/inicio_3.png)">
                                                <th colspan="6" scope="col"><span class="Estilo5">
                                                        <label><font face="Arial"><b><span class="Estilo13">DATOS IMPORTACIÓN RNMA</span></b></font></label>
                                                    </span></th>
                                            </tr>
                                            <tr>
                                                <th colspan="6"><label><font size="2" face="Arial, Helvetica, sans-serif" >&nbsp;</font></label></th>
                                            ...
                                            state = enable ? "" : "disabled";%>
                                            <tr>
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Orden&nbsp;Ejecucion</b></font></label></span></span></td>
                                                <td>
                                                    <select name="cmbordenejecucion" style="width:200px;">
                                                ...
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Puerto&nbsp;Ingreso</b></font></label></span></span></td>
                                                <td>
                                                ...
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>No.&nbsp;Aceptación</b></font></label></span></span></td>
                                                <td>
                                                    <input type="text" name="txtnoaceptacion" style="width:155px;color:#333333; text-align:center" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Condición&nbsp;Ingreso</b></font></label></span></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Entidad&nbsp;Revisión</b></font></label></span></span></td>
                                                <td>
                                                    <input type="text" name="txtentidadrevision" style="width:155px;color:#333333; text-align:center" />
                                                </td>
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Documento&nbsp;Revisión</b></font></label></span></span></td>
                                                <td>
                                                    <input type="text" name="txtdocrevision" style="width:155px;color:#333333; text-align:center" />
                                                </td>
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Fecha&nbsp;Revisión</b></font></label></span></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Resultado&nbsp;Revisión</b></font></label></span></span></td>
                                                <td>
                                                    <input type="text" name="txtresultadorevision" style="width:155px;color:#333333; text-align:center" />
                                                </td>
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Fecha&nbsp;Expedición</b></font></label></span></span></td>
                                                <td>
                                        ...
                                        <table width="100%" border="0" id="panelRNMA" style="display:none">
                                            ...
                                            <tr style="background:url(../html/images/inicio_3.png)">
                                                <th colspan="6" scope="col"><span class="Estilo5">
                                                        <label><font face="Arial"><b><span class="Estilo13">INFORMACIÓN&nbsp;MAQUINARIA&nbsp;AGRICOLA</span></b></font></label>
                                                    </span></th>
                                            </tr>
                                            <tr>
                                                <th colspan="6"><label><font size="2" face="Arial, Helvetica, sans-serif" >&nbsp;</font></label></th>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="Estilo6"> <span class="Estilo2"><label><font face="Arial, Helvetica, sans-serif"><b>Empresa&nbsp;Habilitación</b></font></label></span></span></td>
                                                <td>
