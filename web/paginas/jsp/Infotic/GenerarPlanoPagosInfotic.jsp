<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*" import="modelo.Model"  import="modelo.Parametro"  errorPage="" %>
<%
try{
 ...
 function reportFechas(){
     ...
     var tipo = document.form.tipo.value;
        if(document.form.fecha1.value.length==10&&document.form.fecha2.value.length==10){
                window.frames[0].location.href = "verPagosInfotic.jsp?fi="+fechaI+"&ff="+fechaF+"&tipo="+tipo;
        }else{
...
-->
    ...
    <body>
		<form name="form" id="form" method="post" action="" onSubmit="return validarCampos()">
			...
			<td colspan="11" align="center"><span class="Estilo2">GENERAL DE PlANO PAGOS </span></td>
