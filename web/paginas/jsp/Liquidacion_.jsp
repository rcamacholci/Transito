...
try{
 ...
 Usuario usuario = (Usuario)session.getAttribute("usuario");
    Taquilla temp = model.consultarTaquillaActivaByUsuario(usuario.getId_usuario());
        ...
        <script language="javascript" type="text/javascript">
            ...
            function consultarConceptos(){
                ...
                if(sede!=null){
                    ...
                    window.frames[3].location.href = "cargarConceptos.jsp?parametro="+opcion+"&like=&placa="+placa;
                }
            }
		    ...
		    placa = document.form.placa.value;
                    opcion = sede.options[sede.options.selectedIndex].value;
                    if(liqrunt==1||liqtransito==1){
                        if(liqrunt==0&&liqtransito==1){
                            var check = 1;
                           window.frames[2].location.href = "liquidarTramites.jsp?check="+check+"&parametro="+opcion+"&placa="+placa;
                        }else{
                            if(liqrunt==1&&liqtransito==0){
                                var check = 2;
                                window.frames[2].location.href = "liquidarTramites.jsp?check="+check+"&parametro="+opcion+"&placa="+placa;
                            }
                        }
              ...
              if(document.form.liqmanual.checked){
                  //alert("ok");
                  document.getElementById('spm').style.display = "block";
                  document.getElementById('pagom').style.display="block";
              }else{
                  //alert("!ok");
                  document.getElementById('spm').style.display = "none";
                  document.getElementById('pagom').value=0;
                  document.getElementById('pagom').style.display="none";
              }
            }
				...
				valor = parseFloat(document.getElementById('totalidad').value);
                                ...
                                if(document.getElementById("tipoPagos").value.length>0){
                                    if(parseInt(document.getElementById("tipoPagos").value)!=1 ){
                                       alert("tipo ->"+parseInt(document.getElementById("tipoPagos").value));
                                ...
                                if(accept&&paso){
                                    if(document.getElementById("tipoPagos").value!=9){
						...
						if(confirm("Esta seguro aplicar esta liquidacion")){
							...
							persona = document.getElementById("propietario").value;
                                                        ...
                                                        pagom = document.getElementById("pagom").value;
							var liqrunt = document.getElementById("liqrunt").checked?1:0;
							var liqtransito = document.getElementById("liqtransito").checked?1:0;
							if(liqrunt!=0||liqtransito!=0){
                                                        window.frames[5].location.href = "factura.jsp?persona="+persona+"&sede="+sede+"&pago="+pago+"&placa="+placa+"&valor="+valor+"&referencia="+referencia+"&fecha="+fecha+"&banco="+banco+"&pagom="+pagom+"&liqrunt="+liqrunt+"&liqtransito="+liqtransito+"&scnc="+codeSec;
							}else{
						...
						alert("No existe persona registrada para la liquidacion del Tramite");
                                       ...
                                       if(document.getElementById("propietario")!=null){
                                            alert(" "+document.getElementById("tipoPagos").value);
                                                if(document.getElementById("tipoPagos").value==9){
                                                    	if(confirm("Esta seguro aplicar esta liquidacion")){
                                                        document.getElementById('impresion').style.display = 'none';
                                                        //document.getElementById('liquidar').style.display = 'none';
							...
							if(liqrunt!=0||liqtransito!=0){
								...
								alert("Debe seleccionar al menos una generacion de pagos");
                                                    ...
                                                    alert("Debe escojer el tipo de pago: PAGO MANUAL");
                                                }
					}else{
						alert("No existe persona registrada para la liquidacion del Tramite");
					}
						   		...
						   		<table align="center" border="0" cellspacing="0" cellpadding="0" width="100%">
									<tr>
										<td width="40%" align="center">
											<span class="Estilo19">Generar&nbsp;liquidacion&nbsp;</span>
                                                                                        <% if(((java.util.LinkedList)session.getAttribute("permisosU")).contains("aplicarPagosTransito")){
                                                                                                ...
                                                                                                <input type="checkbox" name="liqtransito" id="liqtransito" value="1" onclick="consultarTramites()" checked/>
                                                                                             <% }else{ %>
                                                                                                    <input type="checkbox" name="liqtransito" id="liqtransito" value="1" onclick="consultarTramites()" checked disabled/>
                                                                                        <%      }
                                                                                           }else{ %>
                                                                                               <input type="checkbox" name="liqtransito" id="liqtransito" value="0" onclick="consultarTramites()" disabled/>
                                                                                        <% } %>
                                                                                </td>
										<td width="40%" align="right">
											<span class="Estilo19">Generar&nbsp;liquidacion&nbsp;RUNT</span>
                                                                                        <% if(((java.util.LinkedList)session.getAttribute("permisosU")).contains("aplicarPagosRunt")){
                                                                                                if(((java.util.LinkedList)session.getAttribute("permisosU")).contains("aplicarPagosTransito")){ %>
                                                                                                <input type="checkbox" name="liqrunt" id="liqrunt" value="1" onclick="consultarTramites()"/>
                                                                                             <% }else{
                                                                                                    aplicarSinTaquilla = true;  %>
                                                                                                    <input type="checkbox" name="liqrunt" id="liqrunt" value="1" onclick="consultarTramites()" checked disabled/>
                                                                                        <%      }
                                                                                           }else{ %>
                                                                                           <input type="checkbox" name="liqrunt" id="liqrunt" value="0" onclick="consultarTramites()" disabled/>
                                                                                        <% } %>	
                                                                                </td>
									...
									<table width="100%" border="0" >
                                                                        <%
                                                                           ...
                                                                           if(estadoT||aplicarSinTaquilla){  %>
                                                                              <tr>
                                                                                    <th width="15%" scope="col"><input name="limpiar" id="limpiar" type="button" value="Limpiar" onclick="cleaner()" disabled/></th>
                                                                                    ...
                                                                                    <th width="16%" align="right" scope="col"><label id="total"><span class="Estilo15">$&nbsp;0</span></label></th>

                                                                                    <th width="38%" scope="col">
                                                                                        <label style="color: #333333;width:70px" ><span class="Estilo16" style="width:70xp"><span  id="spm" name="spm" class="Estilo19" style="display:none;width:70xp">Nº&nbsp;PAGO:</span></span></label><input name="pagom" id="pagom" type="text" size="15%" maxlength="6" style="display:none;width:200px"/>
                                                                                    </th>


                                                                                        <th width="16%" scope="col"><input name="aplicar" id="aplicar" type="button" value="Aplicar" onclick="liquidacion(1)" disabled/></th>
                                                                              </tr>
                                                                          <% }else{  %>
                                                                               <tr>
                                                                                    <th scope="col" colspan="5"><span class="Estilo19">NO EXISTEN TAQUILLAS ABIERTAS</span></th>
                                                                              </tr>
                                                                          <% }  %>
								   </table>
							  </fieldset>						  </td>
