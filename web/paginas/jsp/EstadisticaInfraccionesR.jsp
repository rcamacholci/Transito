...
--></style>
        	<script language="javascript" type="text/javascript">
				...
				var dir = "comparendos/reporteInfraccionAnual/Reinsidentes.jasper";
                                 var nombre = "Reinsidentes";
    ...
    <body>
     ...
     try{
                        ...
                        System.out.println(fechaI+"<->"+fechaF+"<->"+DOC);

                        HashMap parameters = new java.util.HashMap();
                           parameters.put("DOCUMENTO",DOC);
                           parameters.put("FECHAI",fechaI);
                           parameters.put("FECHAF",fechaF);
                           session.setAttribute("Reinsidentes", parameters);
                           %>
                           <script language="javascript" type="text/javascript">
                            verR();
