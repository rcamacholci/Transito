...
-->
  ...
  <body><form name="forma"  onSubmit="return validarDocumento(this)"  method="post" action="consultarPersonaRUNT.jsp?paso=1" target="persona"><fieldset>
      <table width="60%" border="0"  bordercolor="#FFFFFF" align="center" >
	   
	  	<tr style="border:none; background:url(../html/images/inicio_3.png)">
			<td colspan="11" align="center"><span class="Estilo2">INSCRIPCION Y CONSULTA DE PERSONA NATURAL/JURIDICA</span></td>
	    </tr>
        <tr>
