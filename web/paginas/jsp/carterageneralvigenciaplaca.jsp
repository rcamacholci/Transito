...
<%
            try {
              ...
              if (((java.util.LinkedList) session.getAttribute("permisosU")).contains("carterageneralvigenciaplaca.jsp")) {
...
-->
        ...
        <script language="javascript" type="text/javascript">
            function GenerarReporteExcel(){
                window.frames[0].location.href = "VerReporteExcelVigenciaYPlaca.jsp";
            }
            function GenerarReporte(){
                ...
                var dir = "cartera/detallecarteravigenciaplacasaldo.jasper";
                var nombre = "resportecarterageneralvigenciayplaca";
...
<td colspan="11" align="center" class="style9">LISTADO DE CARTERA GENERAL DISCRIMINADO POR VIGENCIA Y PLACA </td>
			 </tr>
                <tr >
                  ...
                  <td width="20%" align="center">
					  <%
                       ...
                       //parameters.put("USUARIO", usuario.getNombre());
                        session.setAttribute("resportecarterageneralvigenciayplaca", parameters);
			           %>
...
<button id="generar"  name="generar" type="button" onClick="GenerarReporteExcel()"><span class="style2">Generar Excel</span><img src="../html/images/excel.png"  width="19" height="18"/></button>
