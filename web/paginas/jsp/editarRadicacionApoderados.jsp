...
<script language="javascript" type="text/javascript">
	...
	function eliminar(){
		...
		document.location.href = "editarRadicacionApoderados.jsp?tipo=3&propietario="+prop;
	}
			...
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4) {
					...
					if(respuesta == "nueva"){
						...
						document.getElementById("tporcentaje").disabled = true;
		...
		ajax2.onreadystatechange=function() {
			if (ajax2.readyState==4) {
				...
				if(parseInt(respuesta) == 0){
					...
					document.location.href = "editarRadicacionApoderados.jsp?tipo=2&tipod="+dato3+"&documento="+dato4+"&propietario="+prop;
				}else{
	...
	function salir(){
		document.location.href = "editarRadicacionPropietarios.jsp";
	}
</script>
</head>
<body>
...
<table width="70%" border="0" align="center">
 ...
 <%  Radicacion_Apoderado apoderado =(Radicacion_Apoderado)session.getAttribute("editarApoderados"+propietario.getId_persona());
  	 if(apoderado==null){
	 	apoderado = new Radicacion_Apoderado();
	 }
	 if(request.getParameter("tipo")!=null){
		 if(request.getParameter("tipo").equals("1")){
			session.setAttribute("editarApoderados"+propietario.getId_persona(),apoderado);
		 }else{
...
<%	}
	...
	<input type="hidden" id="nprop" value="1" />
	  <tr>
		<td align="center"><input name="ttipo" type="text" id="ttipo" ondblclick="verT(this)" value="<%=tipos2.get((persona!=null?persona.getTipo_documento():1)+"")%>" readonly="true" style="text-align:center; color:#333333; font-family:Arial, Helvetica, sans-serif; width:130px; font-size:11px"/>
		  <select name="tipo" id="tipo" style="display:none; font-size:11px; width:130px" onchange="aplicarT(this)">
		...
		<td align="center"><input name="tdocumento" type="text" id="tdocumento" value="<%=(persona!=null?persona.getDocumento():"")%>" onblur="consultaPersona(this)" style="text-align:center; color:#333333; font-family:Arial, Helvetica, sans-serif; width:100px; font-size:11px"/></td>
		<td align="center">
		<%  if(persona!=null){
				if (persona.getTipo_documento() != 2) {%>
				<input name="tnombre" type="text" id="tnombre" value="<%=persona.getApellido_1() + " " + (persona.getApellido_2() != null ? persona.getApellido_2() : "") + " " + persona.getNombre_1()%>" readonly="true" style="color:#333333; font-family:Arial, Helvetica, sans-serif; width:250px; font-size:11px"/>
                    <%} else {%>
                <input name="tnombre" type="text" id="tnombre" value="<%=persona.getNombre_1()%>" readonly="true" style="color:#333333; font-family:Arial, Helvetica, sans-serif; width:250px; font-size:11px"/>
                   <% }
		    }else{ %>
				<input name="tnombre" type="text" id="tnombre" value="" readonly="true" style="color:#333333;font-family:Arial, Helvetica, sans-serif; width:250px; font-size:11px"/>
	<%		}
