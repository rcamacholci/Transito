    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            function consultarPlacas(){
                if(document.form.placa.value.length>=1&&document.form.placa.value.length<=8){
                    var nplaca = document.form.placa.value;
				    document.form.placax.value = document.form.placa.value;
					window.frames[0].location.href = "verDatosVehiculo.jsp?id=0&placa="+nplaca;
					document.form.action = "verDatosVehiculo.jsp?id=0&placa="+nplaca;
					return true;
                }else{
...
-->
    ...
    <body onLoad="obtener()"> 
        <table width="100%" border="0" align="center">
			...
			<td colspan="11" align="center"><span class="style2 style14 Estilo32">CONSULTA DE VEHICULO</span></td>
		  </tr>
                            <tr>
                              ...
                              <th width="16%" scope="col"> <input id="placa" name="placa" type="text" maxlength="8" style="text-align:center;color:#333333; font:bold; text-transform:uppercase; width:150px"/></th>
                              <th width="7%" scope="col"><input id="consultarPlaca"  name="consultarPlaca" type="button" value="Consultar"  onclick="consultarPlacas()" /></th>
