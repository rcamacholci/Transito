<%
    try{
    	...
    	if(model!=null){
            if(((java.util.LinkedList)session.getAttribute("permisosU")).contains("adicionarComparendo.jsp")){
                procesos.procesoContravencional procesoContravencional = new procesos.procesoContravencional();
                boolean respuesta = procesoContravencional.ingresarComparendo(model, usuario, request);
                if(respuesta){ %>
