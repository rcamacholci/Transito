...
<root>
    ...
    <result>1</result>
    <mensaje>Edicion Correcta!</mensaje>
    <%} else {%>
    <result>2</result>
    <%    if (!ext) {%>
    ...
    <%}
                ...
                %><result>3</result>
                <mensaje>Se ha producido un error durante el ingreso del color por favor comuniquece con Soporte Tecnico Error: <%=e%> </mensaje>                
                <%
                e.printStackTrace();
            }
