...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <%
            ...
            boolean execP = ( "1".equals(request.getParameter("")) ? true : false );
                ...
                <td colspan="4" >
                    <table width="100%" border="1" cellpadding="1" cellspacing="0">
                                                            ...
                                                            if (liquidacion.getTipo() == 2) {
                                                                ...
                                                                if (liquidacion.getFk_concepto() >= 32 && liquidacion.getFk_concepto() <= 35) {
                                                                    ...
                                                                    if (vigenciaInicial != 0) {
                                                                        PreCartera cartera = new PreCartera();
                                                                        ...
                                                                        long fkCartera = model.adicionarPreCartera(cartera);
                                                                        while (iter.hasNext()) {
                                                                            long key = iter.next();
                        ...
                        <%
                            ...
                            for (int i = 0; i < listaLiquidacion.size(); i++) {
                                ...
                                if (liquidacion.getTipo() == 1) {
                                    PreCartera cartera = model.consultarPreCartera(liquidacion.getId_liquidacion());
                                    Detalle_Tiquete dt = new Detalle_Tiquete();
                                    dt.setCantidad(liquidacion.getCantidad());
                                    ...
                                    System.out.println("VA SUM  " + sumatoria + " >= " + liquidacion.getTotal());
                                    ...
                                    if (sumatoria >= liquidacion.getTotal()) {
                                        ...
                                        /*if ( execP ) {
                                            ...
                                            if (cartera.getTipo() == 1) {
                                                ...
                                                System.out.println("ID_CARTERA   " + cartera.getId_cartera() + "    " + cartera.getReferencia());
                        ...
                        <%
                            ...
                            String dir = application.getRealPath("paginas/reports/recaudoycartera/pagos/multipleTiquetePagoReport2.jasper");
