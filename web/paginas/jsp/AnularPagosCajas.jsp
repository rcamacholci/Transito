 ...
 function reportFechas(){
     ...
     var fechaF = document.form.fecha2.value;
        if(document.form.fecha1.value.length==10&&document.form.fecha2.value.length==10){
                window.frames[0].location.href = "verAnularPagos.jsp?fi="+fechaI+"&ff="+fechaF;
        }else{
...
function buscarR(){
        if(document.form.fecha1.value.length==10&&document.form.fecha2.value.length==10){
                window.frames[0].location.href = "verAnularPagos.jsp?fi="+document.form.fecha1.value+"&ff="+document.form.fecha2.value+"&opcion=1";
        }else{
...
-->
    ...
    <body>
		<form name="form" id="form" method="post" action="" onSubmit="return validarCampos()">
			...
			<td colspan="11" align="center"><span class="Estilo2">CAJA GENERAL DE PAGOS </span></td>
