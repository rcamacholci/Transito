...
<%
     ...
     try{
            ...
            String nFile = "C:/Civitrans/transito/build/web/paginas/data/simit/"+fecha_reporte+"/"+simitplano.getConsecutivo()+"/08000000comp.txt";
            ...
            response.setHeader("Content-Disposition","attachment;filename= 08000000comp.txt");
