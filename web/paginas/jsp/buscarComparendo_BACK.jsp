        ...
        <script language="javascript" type="text/javascript">
            function consultarComparendo(){
                if(document.form.comparendo.value.length>0){
                    ...
                    window.frames[0].location.href = "datosComparendo.jsp?id=0&comparendo="+ncomparendo;
                }else{
            ...
            <form name="form" id="form" method="post" action="javascript:consultarComparendo()">
                ...
                <fieldset>
                    <table width="100%" border="0">
                        <tr class="title_">
                            <td colspan="11" align="center"><span>CONSULTAR COMPARENDOS </span></td>
                        </tr>
                        <tr>
                ...
                <table width="100%" border="0" align="left" >
                    <tr>
                        <th height="469" colspan="4" class="Estilo4" scope="col" valign="top">
                            <iframe src="#" id="vehiculo" name="vehiculo" frameborder="0" marginwidth="0" height="580" width="100%" marginheight="0" align="top" scrolling="no"></iframe>
                        </th>
                    </tr>
                </table>
            </td>		
