    ...
    if(request.getParameter("placa")!=null){
        ...
        if(vehiculo!=null){
            ...
            if(datoCilindraje!=null && datoCilindraje.getValor()!=null){
                cilindrajeVeh = Long.parseLong(datoCilindraje.getValor().trim());
            }else{
                Mensaje += "\n Cilindraje";
                ValidaDatos=1;
            }
            ...
            if(datoModalidad!=null && datoModalidad.getValor()!=null){
                modalidadVeh = Long.parseLong(datoModalidad.getValor().trim());
            }else{
                Mensaje += "\n Tipo de movilidad";
                ValidaDatos=1;
            }
            ...
            if(claseVeh!=0 && claseVeh!=10 && claseVeh!=14 && claseVeh!=19){
                if(modalidadVeh==2){
                    ...
                    if(datoCarroceria!=null && !datoCarroceria.getValor().trim().equals("0")){
                        carroceriaVeh = Long.parseLong(datoCarroceria.getValor().trim());
                    }else{
                        Mensaje += "\n Carroceria";
                        ValidaDatos=1;
                    }
            ...
            if(servicioVeh==2){
                ...
                if(datoSubServicio!=null && !datoSubServicio.getValor().trim().equals("0")){
                    subServicioVeh = Long.parseLong(datoSubServicio.getValor().trim());
                }else{
                    Mensaje += "\n Subservicio";
                    ValidaDatos=1;
                }
...
%>
<valorRetencion>0</valorRetencion>
<sw>Error en proceso <%=e.getMessage()%></sw>
<%
        }
%>
</root>