<%-- 
    Document   : getDatos
    Created on : 18/08/2011, 10:01:42 PM
...
<html>
    ...
    <body>
        <form name="form" action="procesarDatos.jsp" method="POST" enctype="multipart/form-data" target="respuesta">
            <table align="center" border="0" width="100%">
                <tr>
                    <td  height="40px" align="center">
                        <h1 class="style1">Datos InscP</h1>
                    </td>
                </tr>
                <tr>
                    <td height="40px" align="center">
