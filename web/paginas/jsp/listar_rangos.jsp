...
<script type="text/javascript" language="javascript">
	function ver_venales(id){
		document.location.href = "listar_venales.jsp?rango="+id+"&id=0&n=1";
	}
	function newC(){
...
<legend class="style4" align="center">LISTADO DE RANGOS DE ESPECIES VENALES</legend></div>
...
<table width="100%" border="1" align="center" cellpadding="1" cellspacing="0" >
  ...
  <%     
         ...
         List listRangos;	
         listRangos =modelo.listConsultarRangos();
      
         Rango rango= new Rango();
         Iterator itt = listRangos.iterator(); 
         while (itt.hasNext()) {
                   rango = (Rango)itt.next(); 
                   parametro=modelo.consultarParametro( rango.getTipo(), 161);
                   int total= modelo.consultar_Total_Venales(rango.getId_rango());
                   int activos= modelo.consultar_Estado_Venales(rango.getId_rango(),1);
                   int utilizados=modelo.consultar_Estado_Venales(rango.getId_rango(),2);
                  
         %>
          
         <tr id="<%=rango.getId_rango()%>" ondblclick="ver_venales(<%=rango.getId_rango()%>)" onMouseOver="sombrear(this)" onMouseOut="renovar(this)" style="cursor:pointer">
    <td width="6%"  style="color:#000000"><div  align="center" class="style4"  style="font-size:12px"><strong> <%= rango.getId_rango()%></strong> </div></td>
    ...
    <td width="10%" style="color:#000000" align="center"><div class="style4"  style="font-size:12px"><strong><%= rango.getNumero_ini()  %></strong></div> </td>
    <td width="10%" style="color:#000000" align="center"><div class="style4"  style="font-size:12px"><strong><%=rango.getNumero_fin() %></strong></div> </td>
