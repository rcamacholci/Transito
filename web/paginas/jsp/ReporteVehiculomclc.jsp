...
-->
    ...
    <script language="javascript" type="text/javascript">
		...
		var tabla = document.getElementById('carroceriadiv');
		var clase = document.getElementById('clases').value;
		ajax2=nuevoAjax();
		ajax2.open("POST", "cargarCarroceria.jsp",true);
		ajax2.onreadystatechange=function() {
			if (ajax2.readyState==4) {
				tabla.innerHTML = ajax2.responseText;
			}
		...
		ajax2.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		ajax2.send("clase="+clase+"&linea=0");
	}
		  	...
		  	<td colspan="6">&nbsp;</td>
               ...
               <tr align="left" class="style1">
                 ...
                 <td width="27%" scope="col"><span style="font-size: 10px">
                   <select name="clases" id="clases"  style="width:202px; font-size:10px; color:#333333" onChange="buscarCarroceria()">
                 ...
                 CARROCERIA</span></td>
				 <td>&nbsp;</td>
                 <td><div id="carroceriadiv"></div></td>
           </tr>
               <tr align="left" class="style1">
                   <td><span class="Estilo6">
                   MARCA
...
<tr align="left" class="style1">
		 ...
		 <table width="90%" border="0" align="center">
          <tr>
            ...
            <td width="100%" height="31"  scope="col" align="center"><input name="adicionar" type="button" id="adicionar" value="Consultar" style="width:100px; text-align:center" onClick="validar()"/></td>
