    ...
    function verReporte(){
        ...
        function GenerarPlaca(){
            if(document.form.oficioComercial.value.length>0){
                ...
                window.frames[0].location.href = "listaPlacas.jsp?cantVeh="+cant+"&id_oficio="+idOficio+"&oficioC="+oficioC;
            }else{
        ...
        function GenerarDocumento(){
             if(document.form.oficioComercial.value.length>0){
                ...
                var idOficio = document.form.id_oficio.value;
                var oficioC = document.form.oficioComercial.value;
                window.frames[0].location.href = "listaDocumentos.jsp?cantDoc="+cant+"&id_oficio="+idOficio+"&oficioC="+oficioC;
             }else{
                alert("Favor digite el No de Oficio Comercial");
            }
        }
...
if(solicitudO.getEstado()!=2){    %>
  ...
  <td colspan="2" align="left"><input type="text"  id="oficioComercial" name="oficioComercial"  style="width:150px "></td>
  </tr>
<tr style="border:none; background:url(../html/images/inicio_3.png)">
