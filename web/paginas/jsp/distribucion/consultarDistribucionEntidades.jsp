    ...
    <body>
		<form name="form" id="form" method="post" action="verPrestamos.jsp">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="8" align="center" valign="middle"><span class="style1">REPORTE DISTRIBUCION DE PAGOS POR ENTIDADES </span></td>
				</tr>
				<tr>
				        ...
				        <fieldset>
							...
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr align="center" class="style2">
									...
									<td colspan="1" style="border-right:none"><span class="style2">Entidad </span></td>
									<td colspan="1">
									<% Model model = (Model)session.getAttribute("model");%>
										<select name="entidad" id="entidad" style="color:#333333; width:150px">
