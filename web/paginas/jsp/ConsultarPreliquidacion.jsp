		...
		<script language="javascript" type="text/javascript">
			...
			function buscarPago(){
				if(document.form.pago.value.length!=0){
					window.frames[0].location.href = "VerPreliquidacion.jsp?pago="+document.form.pago.value;
				}else{
...
<%  }
	    ...
	    %>
    <body>
        <form name="form" id="form" method="post" action="VerPreliquidacion.jsp" target="respuesta">
	        <fieldset>
			<table width="100%" border="0" align="center">
			<tr style="border:none; background:url(../html/images/inicio_3.png)">
				<td colspan="6" align="center" valign="middle"><span class="style7">CONSULTAR PRELIQUIDACIONES</span></td>
			</tr>
				<tr align="center">
