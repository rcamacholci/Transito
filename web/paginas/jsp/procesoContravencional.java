...
import modelo.auditoria_comparendo;
...
public class procesoContravencional {
    ...
    public boolean ingresarComparendo(Model model, Usuario usuario, javax.servlet.http.HttpServletRequest request) {
        try {
            if (model != null && usuario != null) {
                ...
                System.out.println("paso if_1+-->");
                    if (comparendo.trim().length() > 0) {
                        System.out.println("paso if_comparendo+-->"+comparendo);
                        if (fecha.trim().length() == 10) {
                            System.out.println("paso if_fecha+-->"+fecha);
                            if (horas.length() >= 0 && minutos.length() >= 0) {
                                System.out.println("paso if_hora+-->"+horas);
                                lugar = lugar.trim().toUpperCase();
                                if (lugar.length() > 5) {
                                    System.out.println("paso if_lugar+-->"+lugar);
                                            ...
                                            if (infraccion.length() > 0) {
                                                ...
                                                if ((licenciaConduccion.length() > 0 && fechaVencimiento.length() == 10) || licenciaConduccion.length() == 0) {
                                                    if (placaAgente.length() > 0) {
                                                        System.out.println("paso if_agen+-->"+placaAgente);
                ...
                if (paso) {
                    System.out.println("paso if_paso+-->"+paso);
                 ...
                 //   int valorAdicional = 14000;
                    ...
                    try {
                        ...
                        if (parqueaderos.length() > 0) {
                            ...
                            System.out.println("paso if_parque+-->"+parque);
                        }
                                        ...
                                        if (a != null) {
                                            ...
                                            if (v != null) {
                                                ...
                                                if (lit.equals("")) {
                                                    ...
                                                    if (lt != null) {
                                                        System.out.println("paso if_lit");
                                                        lit = lt.getNumero();
                                                    }
                                                }
                                            }
                                            if (lic.equals("")) {
                                                System.out.println("paso if_lic");
                                                modelo.Licencia_Conduccion lc = model.consultarLicenciaIdPersona(p.getId_persona());
                                                if (lc != null) {
                                                    System.out.println("paso if_lic2");
                                           ...
                                           //     cartera.setSaldo(vi.getValor()+valorAdicional);
                                                ...
                                                if (idCartera != 0) {
                                                    System.out.println("paso if_cartera+-->"+idCartera);
                                                    ...
                                                    long valor = 0;
                                                     if (cp == 1) {
                                                    System.out.println("paso if_cartera+-->"+cp);
                                                        ...
                                                        porcentajeP = 0.45;
                                                        porcentajeS = 0.00;
                                                        System.out.println("adicion IF_OK OK");
                                                        ...
                                                        model.adicionarDetalleCartera(detalleCartera);
                                                         System.out.println("adicion IF_OK OK");
                                                        detalleCartera.setFk_concepto(8549);
                                                        valor = 14000;
                                                        total -= valor;
                                                        detalleCartera.setValor(valor);
                                                        model.adicionarDetalleCartera(detalleCartera);
                                                    }else{
                                                        System.out.println("paso if_else_cp");
                                                        detalleCartera.setFk_concepto(12);
                                                 ...
                                                 /* System.out.println("OK OK");
                                                    detalleCartera.setFk_concepto(8549);
                                                    detalleCartera.setValor(14000);*/
                                                    System.out.println("adicion DETALLE");
                                                    model.adicionarDetalleCartera(detalleCartera);
                                                    System.out.println("adicion inicio");
        ...
        if (comparendo != null) {
            ...
            if (persona != null) {
                ...
                if (curso != null) {
                    ...
                    simitResolucion.setRESFHASTA("01/01/1900");
                    ...
                    simitResolucion.setRESORGANISMO("08001000");
        ...
        try {
            ...
            if (cartera != null) {
                ...
                if (persona != null) {
                    ...
                    System.out.println("VALOR CARTERA: "+cartera.getValor());
                    simitComparendo.setCOMVALINFRA(cartera.getValor() + "");
                    System.out.println("ID CARTERA: "+cartera.getId_cartera());
                    System.out.println("SEDE: "+cartera.getFk_sede());
                    float valorAdicional = model.valorDetalleCarteraAtributos(cartera.getId_cartera(),cartera.getFk_sede(),7);
                    simitComparendo.setCOMVALAD(valorAdicional +"");
                    System.out.println("SALDO DE CARTERA: "+cartera.getSaldo());
                    simitComparendo.setCOMVALOR(cartera.getSaldo() + "");
    ...
    public void generarPlanoRecaudo(Model model,int estado,long idSimiPlano,String oficio,String dir) throws Exception{
        ...
        String x = ",";
        int i = 1;
        String encabezado = "0"+x+hoy()+x+hoy()+"08000000"+x+"1";
