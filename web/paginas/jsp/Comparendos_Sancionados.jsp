...
-->
    ...
    <body> 
		<form name="form" id="form" method="post" action="" onSubmit="return validarCampos()">
		    ...
		    <legend class="style5"  align="center">COMPARENDOS&nbsp;SANCIONADOS</legend>
		  	</div> 
			
		  </fieldset>
		  <iframe src="VerReporteSamcionados.jsp" width="100%" id="respuesta" height="500"  frameborder="0" scrolling="auto"></iframe>
        </form>               
    </body>
</html>
<%  }else{ %>
