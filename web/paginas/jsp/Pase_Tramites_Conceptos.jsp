...
.style7 {font-weight: bold; color: #FFFFFF; font-size: 12px; font-family: Tahoma; }
	...
	<script language="javascript" type="text/javascript">
		function accion(sec){
			...
			if(text.length>0){
				document.location.href = "Pase_Tramites_Conceptos.jsp?sec="+sec+"&text="+text;
			}else{
				document.location.href = "Pase_Tramites_Conceptos.jsp?sec="+sec;
			}
		}
		...
		function buscarNombre(campo){
			text = campo.value;
			if(text.length>0){
				document.location.href = "Pase_Tramites_Conceptos.jsp?sec=0&text="+text;
			}else{
				document.location.href = "Pase_Tramites_Conceptos.jsp?sec=0";
			}
...
%>
<body>
<form id="form" name="form" method="post" action="aplicar_Pase_Tramites_Conceptos.jsp">
