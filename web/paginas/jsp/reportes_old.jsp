...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function verReporteVehiculosmatriculadosExcel() {
                if (document.getElementById("txt_year").value != 0) {
                    ...
                    arriba = (screen.height) ? (screen.height - alto) / 2 : 100;
                    opciones = 'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=' + barra + ',resizable=no,width=' + ancho + ',height=' + alto + ',left=' + izquierda + ',top=' + arriba;
                    url = "ReporteTramiteExcel.jsp?year=" + document.getElementById("txt_year").value + "&opcion=2";
                    window.open(url, 'popUp', opciones);
                } else {
                    alert("Por favor digite el año sobre el cual desea generar el reporte");
                }
            ...
            function ver() {
                if (document.form.busqueda[0].checked) {
                    ...
                    document.getElementById('Ttabla6').style.display = "none";
                } else {
                        ...
                        if (document.form.busqueda[2].checked) {
                            ...
                            if (document.form.busqueda[3].checked) {
                                ...
                                if (document.form.busqueda[4].checked) {
                                    ...
                                    document.getElementById('Ttabla4').style.display = "none";
                                    document.getElementById('Ttabla5').style.display = "none";
                                    document.getElementById('Ttabla6').style.display = "block";
                                }
                            }
                        }
        ...
        <form name="form" id="form" method="post" action="">
            <fieldset>		    
                <table width="100%" border="0" align="center">
                    ...
                    <td colspan="2" valign="middle" align="center" width="20%"><span class="Estilo11">
                            <input type="radio" name="busqueda" id="busqueda" value="6"  onClick="ver()">
                                MATRICULADOS</span></td>
                    </tr>
                    <tr>
                        <td colspan="9">
                            ...
                            <table border="0" width="90%" id="Ttabla6" align="center" style=" display:none">
                                <tr valign="middle">
                                    <td width="15%">&nbsp;</td>
                                    <td width="15%">&nbsp;</td>
                                    <td width="30%" align="center" colspan="2"><span class="style10">ESCRIBA&nbsp;EL A&Ntilde;O</span></td>
                                    <td width="30%" colspan="3" align="center"><span style="font-size: 10px"><span class="style7" style="font-size: 11px">
                                                <input id="txt_year" name="txt_year" type="text" style="text-align:center;color:#333333;font:bold; width:100px"/>
                                            </span>

                                        </span></td>
                                    <td width="15%">&nbsp;</td>
                                    <td><div align="right"><a href="#" onclick="verReporteVehiculosmatriculadosExcel()"><img src="../html/images/excel.png" height="25px" width="25px" title="Generar Reporte Excel"></a></div></td>
