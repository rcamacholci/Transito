...
public class aplicarPago {
    ...
    public boolean adicionarPagoBanco(Model model,long idTaquilla,long idSede,long idUsuario,java.sql.Date fechaPago,long idPersona,long idVehiculo,float valor,String referencia,java.sql.Date fechaReferencia,long banco) {
        ...
        try{
            ...
            model.AjustarValorInteresCostas(idVehiculo,idUsuario,fechaPago);
